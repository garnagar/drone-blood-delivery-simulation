...
DRONE_EMISSIONS_PER_KWH = 0.116             # kg of CO2 per kWh
...
DIESEL_COST = 0.911                         # € / l
AMBULANCE_EMISSIONS_PER_LITER = 2.684        # kg of CO2 per liter of Diesel

# Conversions
HOURS_TO_MIN = 60

# Distribution centre
DIST_CENTER_LONG = 36.806178835957006
DIST_CENTER_LAT = -1.3044652993505275
...
BLOOD_AMOUNT_MEAN_CATASTROPHE = 45         # blood units
BLOOD_AMOUNT_SIGMA_CATASTROPHE = 2.95
BLOOD_AMOUNT_MIN_CATASTROPHE = 55
BLOOD_AMOUNT_MAX_CATASTROPHE = 85
